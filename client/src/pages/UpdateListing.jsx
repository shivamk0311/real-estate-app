...
export default function CreateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
        ...
        const res = await apiFetch(`/listing/get/${listingId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try{
        ...
        setLoading(true);
        setError(false);
        const res = await apiFetch(`/listing/update/${params.listingId}`,
            {
                method: 'POST',
                headers: {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-center text-3xl font-semibold my-7'> Update a Listing</h1>
        <form  onSubmit = {handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div>
                    <div className='flex flex-wrap items-center gap-4'>
                        <input 
                            ...
                            min={1} 
                            required 
                            className='border-gray-300 bg-white p-3 w-13 rounded-lg' 
                            onChange={handleChanges}
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button 
                    ...
                    className='p-3 bg-amber-900 text-white uppercase rounded-lg hover:opacity-90 disabled:opacity-80 my-4' >
                        {loading ? 'Updating...' : 'Update Listing'}
                </button>
                {error && <p className="text-red-700 sm mt-2">{error}</p>}
            </div>
